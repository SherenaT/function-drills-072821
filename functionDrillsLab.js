...
//CODE HERE
const addingNumbers = function (num1, num2) {
  return num1 + num2;
};

let sum = addingNumbers(4, 90);
...
const faveColorFinder = function (color) {
  if (color === "red") {
    ...
    console.log(
      `Your favorite color is ${color}?! You need to evaluate your favorite color choice.`
    );
  }
};
...
//CODE HERE
let printAllNames = function (names) {
...
//CODE HERE
let frogSale = function (gold) {
  return Math.floor(gold / 3);
};

let totalFrogs = frogSale(35);
...
//CODE HERE
const asscendingArray = function (num) {
...
let arrayIsAscending = asscendingArray(sampleArray);
